...
Original file is located at
    https://colab.research.google.com/drive/1b2YQ1TX67D4VSUHYsoTaqa6I1Z10vCUh
"""
...
!export WANDB_MODE=disabled && cd yolov5 && python train.py --img-size 640 --batch-size 16 --epochs 100 --data {data_path}/data.yaml --cfg yolov5s.yaml --weights '' --name yolov5_car_detection --cache
